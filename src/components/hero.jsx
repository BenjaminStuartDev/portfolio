  ...
  return (
    <div className="flex flex-row">
      ...
      <div className="h-screen w-full lg:w-1/2 flex flex-col justify-center">
        <h1 className="text-4xl md:text-5xl tracking-wide text-white font-montserrat inline-block ">
          <span>
            {name}
            <span className="font-inter font-thin pl-4">|</span>
          </span>
        </h1>
        <h2 className="text-1xl md:text-2xl text-platinum-silver font-inter font-light">
          {role}
        </h2>
      </div>
